...
namespace HP_Parking_WEB_API
{
    ...
    public interface IHPParking
    {
        ...
        /// <summary>
        /// Amit Singh 05 June 2016
        /// Parking full tag Identifiers 
        /// 0---Parkingfull
        /// 1---Available  
        /// 2---Not Known
        /// </summary>
        ...
        [OperationContract]
        [WebInvoke(Method = "GET", ResponseFormat = WebMessageFormat.Json, BodyStyle = WebMessageBodyStyle.Wrapped, UriTemplate = "getParkingRateing_JSON/{ParkingId}")]
        string getParkingRateing_JSON(string ParkingId);

        [OperationContract]
        [WebInvoke(Method = "GET", ResponseFormat = WebMessageFormat.Xml, BodyStyle = WebMessageBodyStyle.Wrapped, UriTemplate = "getParkingRateing_XML/{ParkingId}")]
        string getParkingRateing_XML(string ParkingId);
